...
class MyPermissions {
  ...
  Future<bool> checkStoragePermission() async {
    ...
    var storageStatus = android.version.sdkInt < 33
        ? await Permission.storage.request()
        : PermissionStatus.granted;
    var externalStorageStatus = android.version.sdkInt < 33
        ? PermissionStatus.granted
    ...
    if (storageStatus == PermissionStatus.granted &&
      ...
      return true;
        ...
        externalStorageStatus == PermissionStatus.denied) {
      return false;
    } else if (storageStatus == PermissionStatus.permanentlyDenied ||
        externalStorageStatus == PermissionStatus.permanentlyDenied) {
      return false;
    }
    return false;
  }
  ...
  Future<List<FileSystemEntity>> getFiles() async {
    ...
    if (await nlManager.exists()) {
      List<FileSystemEntity> filesAndFolders =
          nlManager.listSync(recursive: true);
